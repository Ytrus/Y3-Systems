...
//--------------------------+
string bot_name = "ST System 0.3.0"; // Per il TP e lo SL uso l'ATR orario (2x e 1x), poi muovo lo SL al salire del profitto
   ...
   switch(Period())
     {
      ...
      case 60:    slowerPeriod=240; break;
...
//-----------------enter buy order---------------------------+
   ...
   if ((Close[0] <= trendUp) && (trendUp != EMPTY_VALUE))      buyConditions[0] = true;   // Tocco il trendUp
   if (Open[0] > trendUp)                                      buyConditions[1] = true;   // vengo dall'alto
...
//-----------------enter sell order----------------------------+
   ...
   if ((Close[0] >= trendDown) && (trendDown != EMPTY_VALUE))  sellConditions[0] = true;   // Tocco il trendDown
   if (Open[0] < trendDown)                                    sellConditions[1] = true;   // vengo dal basso
