...
//--------------------------+
string bot_name = "AMA System 0.3.0"; // Per il TP e lo SL uso l'ATR orario (2x e 1x), poi muovo lo SL al salire del profitto
...
//-----------------enter buy order---------------------------+
   ...
   if (AMAslowUP[0] > 0)                                       buyConditions[0] = true;   // il trend superiore è UP
   if ((AMAfastUP[1] == 0) && (AMAfastUP[0] > 0) )             buyConditions[1] = true;   // nasce il pallino blu nel Timeframe attuale
...
//-----------------enter sell order----------------------------+
   ...
   if (AMAslowDOWN[0] > 0)                                     sellConditions[0] = true;   // il trend superiore è DOWN
   if ((AMAfastDOWN[1] == 0) && (AMAfastDOWN[0] > 0) )         sellConditions[1] = true;   // nasce il pallino rosso nel Timeframe attuale
