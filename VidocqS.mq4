...
//--------------------------+
string bot_name = "VidocqS 0.2.0"; //Va solo SHORT
...
extern string COMMENT = "VidocqS";
extern string nameOfHistoryFile = "VidocqS_HST_";
...
/*   
   if (Volume[0] < 30)                                         buyConditions[0] = true;   // Apro solo all'inizio della barra
...
//-----------------enter sell order----------------------------+
   ...
   if (Volume[0] < 30)                                         sellConditions[0] = true;   // Apro solo all'inizio della barra
