...
// imposto delle variabili per prendere apertura, chiusura, massimo e minimo dell'Haiken_Ashi
...
//-----------------enter buy order---------------------------+
   ...
   // buyConditions array
   if ((startTime <= tm) && (tm < endTime))                    buyConditions[0] = true; // orario di trading
